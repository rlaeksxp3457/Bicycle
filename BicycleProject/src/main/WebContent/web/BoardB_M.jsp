            ...
            <ol class="list-group">
                <li id="guest_rep_id" class="list-group-item">
                    ...
                    <div class="guest_rep_class">
                        <strong><%=boardDto.getBoard_writer()%>
                        </strong>
                        <small><%=boardDto.getBoard_regdate()%>
                        </small>
                        <span class="control">
<!-- 자신의 댓글에 대한 권한 주기 --> 
<%
                                ...
                                <ul class="list-group">
                                    <li id="guest_rep_id" class="list-group-item">
                                        <div class="guest_rep_class">
                                            ...
                                            <small><%=CommentDto.getComment_regdate()%>
                                            </small>
                                            <span class="control">
<!-- 자신의 대댓글에 대한 권한주기 -->
<%
        ...
        <nav style="text-align: center;">
            <ul class="pagination">
                ...
                <li class="page-item active"><a
                        href="./BoardB_M.jsp?pageNum=<%=startNum + i%>"><%=startNum + i%>
                </a></li>
                <%
                } else {
                %>
