        ...
        <div class="panel panel-default">
            <table class="table table-hover">
                ...
                <tr onclick="location.href ='BoardB_view.jsp?board_id=<%=boardDto.getBoard_id()%>'">
                    <!-- 번호  -->
                    <td><%=boardDto.getBoard_id()%>
                    </td>
                    <!-- 제목  -->
                    <td><%=boardDto.getBoard_title()%> [<%=commentDao.countComment(boardDto.getBoard_id())%>]</td>
                    <!-- 날짜 -->
                    <td><%=boardDto.getBoard_regdate()%>
                    </td>
                    <!-- 아이디 -->
                    <td><%=boardDto.getBoard_writer()%>
                    </td>
                    <!-- 조회수 -->
                    <td><%=boardDto.getInfo_hit()%>
                    </td>
                </tr>
                </tbody>
                <%
        ...
        <nav style="text-align: center;">
            <ul class="pagination">
                ...
                <li class="page-item active"><a
                        href="./BoardB_view.jsp?pageNum=<%=startNum + i%>"><%=startNum + i%>
                </a></li>
                <%
                } else {
                %>
