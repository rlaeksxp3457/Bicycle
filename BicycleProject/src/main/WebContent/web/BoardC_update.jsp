...
<form
        action="BoardC_update_action.jsp?market_id=<%=boardcDto.getMarket_Id()%>"
        ...
        <div class="col-lg-8">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="제목"
                       name="board_title" value="<%=boardcDto.getBoard_Title()%>"
                       required>
            </div>
        </div>
        <div class="col-lg-1"></div>
        ...
        <div class="col-lg-8">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="가격"
                       name="market_price" value="<%=boardcDto.getMarket_Price()%>"
                       required>
            </div>
        </div>
        <div class="col-lg-1"></div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="form-group">
                <label for="filename"><%=add_fileDto.getFile_name()%>
                </label> <input
        ...
        <div class="col-lg-8">
            <div class="form-group">
					<textarea class="form-control" rows="20" placeholder="내용을 작성해주세요."
                              maxlength="2048" style="height: 350px;" name="Board_content"
                              required><%=boardcDto.getBoard_Content()%></textarea>
            </div>
            <button type="submit" class="btn btn-primary" style="float: right;">글
                수정
            </button>
        </div>
        <div class="col-lg-1"></div>
