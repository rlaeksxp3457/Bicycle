...
<div class="row">
    ...
    <div class="col-lg-10">
        <table class="table table-striped"
            ...
            <tr>
                <td>작성자</td>
                <td colspan="2"><%= boardDto.getBoard_writer() %>
                </td>
            </tr>
            <tr>
                <td>작성일자</td>
                <td colspan="2"><%= boardDto.getBoard_regdate() %>
                </td>
            </tr>
            <tr>
                <td>내용</td>
                <td colspan="2"><%= boardDto.getBoard_content() %>
                </td>
            </tr>
            </thead>
        </table>
...
<div class="row">
    ...
    <div class="col-lg-2"><a href="admin_BoardB_Q.jsp" class="btn btn-primary">목록</a>
        <a onclick="return confirm('정말로 삭제하시겠습니까?')"
           href="admin_BoardB_delete.jsp?board_id=<%= boardDto.getBoard_id()%>" class="btn btn-primary ">삭제</a>
    </div>
    <div class="col-lg-1"></div>
</div>
