        ...
        <div class="row mb-3">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="card text-center w-100"
                    ...
                    <div class="card-body">
                        <p class="card-text"><%=boardcDto.getCategory_Small()%>
                        </p>
                        <p class="card-text"><%=boardcDto.getBoard_Editdate()%>
                        </p>
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="border border-dark">
                ...
                <button class="btn btn-secondary m-3"
                        onclick="location.href ='BoardB_view.jsp?board_id=<%=boardDto.getBoard_id()%>'">보러가기
                </button>
            </div>
